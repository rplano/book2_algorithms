...
/* Class: GThickLine */
/**
 * The <code>GThickLine</code> class is a graphical object whose appearance consists
 * of a line segment.
 */
public class GThickLine extends GObject implements GScalable {
 ...
 */
	public GThickLine(double x0, double y0, double x1, double y1, int strokeWidth) {
		setLocation(x0, y0);
		dx = x1 - x0;
		dy = y1 - y0;
		this.strokeWidth = strokeWidth;
 ...
 */
	public void paint(Graphics g) {
        ...
        g2.draw(new Line2D.Float(GMath.round(x), GMath.round(y), GMath.round(x + dx), GMath.round(y + dy)));
	}
